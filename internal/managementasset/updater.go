...
func StartAutoUpdater(ctx context.Context, configFilePath string) {
	// If the embedded HTML exists, we don't need to auto update from github.
	if len(GetIndexHTML()) > 0 {
		log.Debug("management asset auto-updater skipped: using natively embedded UI")
		return
	}
